    ...
    <div>
      <Flex>
        <Flex
          ...
          alignItems="center"
          ml={{ base: "80px", "2xl": "150px" }}
          p={{ base: "20px", "2xl": "40px" }}
        >
          <HStack spacing={{ base: "90px", "2xl": "120px" }} justify="center">
            <Box maxW="450px">
              <Image
                src={productInfo.image_url}
                boxSize={{ xl: "410px", "2xl": "450px" }}
                objectFit="cover"
              />
            ...
            <Box>
              ...
              <Text fontSize="lg" pt="5px" mt="3px">
                Quantity
              </Text>
              <NumberInput
                size="lg"
              ...
              {addCartErrMsg && <Text color="red">{addCartErrMsg}</Text>}
              ...
              >
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogCloseButton />
                  <AlertDialogBody>
                    {quantityRef.current.value}x{productInfo.name} was placed in
                    your cart
                  </AlertDialogBody>
                  <AlertDialogFooter>
